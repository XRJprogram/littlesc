...
costumes "a72b11f16ffe5448349326d4e32a7db2.svg" as "背景1", "b0e285c6c024e96b2af2a92e9e049d7b.png" as "black", "d8c2fbecd7daf4fa66b51df118334357.svg" as "窄屏", "40a3edecd54b1910c35999c421b92a73.svg" as "长屏", "2dce7153500f2ccab65e77f5ad1ddaf6.png" as "背景5", "cfe340c69f3f423f90bc700f2442a429.svg" as "Cendy", "78f1c8994065bafc771e04e2af4f7453.svg" as "fce中文";
var Condition = "inhand";
var CurrentCard = "0";
var Cnstage_card_Number = 0;
var CardGap = 14.999994949050341;
var CardHitbox_halfWidth = 97.5;
var CardRadius = 300.0001683649886;
var Camera_X = 0;
var Camera_Y = 116.62219105135657;
var Card_Spread_Angle = 14.999994949050341;
...
var Touchcard_X = 0;
var Touchcard_Y = 150;
var temp_CloneInhandCard = 2;
var Energy = 0;
var StageSize = 50;
var CurrentStagecard = "0";
var return_randnum = 48339;
var PlayerHP = 50;
var PlayerMaxHP = 50;
var RoundCount = 1;
var GameInfo = 0;
...
list InhandCard_name_lv_damage_hp_e_ = ["橡皮", 1, 2, 50, 155, "芙楠", 1, 2, 50, 1];
...
list CardStage_name_lv__4__mhp_buff_ = ["null", "", "", "", "", "", "", "", "null", "", "", "", "", "", "", "", "null", "", "", 0, "", "", "", "", "null", "", "", "", "", "", "", "", "null", "", "", "", "", "", "", "", "晨曦", 1, 2, 50, 1, 5, 50, "", "Alpha", "", 4, 20, 0, 5, 20, "", "西药", 1, 2, 50, 4, 5, 50, "", "樱莲", 1, 3, 50, 2, 5, 50, "", "混沌", 1, 5, 50, 21, 5, 50, ""];
list _EnemyList_name_damage_hp_ = ["电蜂", 6, 30, "守卫", 4, 45];
...
list MapCamera__cur__target___x_y_size__ = [55.16757801238073, -116.49551213145911, 9.999999999999996, 55.14313496916728, -116.5342822379366, 10];
list MapPoint_7_ = ["0-1", 55.13825564062811, -116.54200415354752, -0.004879328539171286, -0.007721915610936376, "fight", "visible", "1-1", 47.91660965789645, -119.08856212497253, -0.00532912813225242, -0.006443234837425288, "fight", "invisible", "1-2", 37.98915711715904, -114.53959565974348, -0.004528237608332278, -0.004686416809864992, "fight", "invisible", "1-3", 29.771244694225178, -105.61053765966372, -0.0029971587415224023, -0.0032560472902367597, "fight", "invisible", "1-4", 24.594178265243446, -94.86869264161157, -0.0012589334500229532, -0.0023915110086680583, "fight", "invisible", "1-5", 19.130142238765792, -83.84646823935907, 0.00044221216198242486, -0.0015255062803473454, "fight", "invisible", "1-6", 9.33700619293251, -74.24580931793409, 0.0017620363738595213, -0.00011139201643262098, "fight", "invisible", "2-1", 6.62904370401887, -61.716176544759946, 0.003126401522546754, 0.0002619773404104464, "fight", "invisible", "2-2", 3.2977535244544773, -51.13439895386571,
, -0.0041241976570101455, "reward", "invisible", "1-3R", 23.815598299605547, -109.40065176832378, -0.00361081682092804, -0.0022535994385047137, "reward", "invisible", "1-5R", 25.316603612430562, -80.4583805131008, 0.0009691101997161278, -0.0024202178289877063, "reward", "invisible", "1-6R1", 1.981609390576056, -72.61552877488336, 0.002040719624874121, 0.0008471068359678924, "reward", "invisible", "1-6R2", 5.877738715328196, -80.96062270728464, 0.0009571361294363756, 0.00035458887025374697, "reward", "invisible"];
...
var cloneType_2 = "putCard//energyNum";
var cloneID_2 = 9;
...
proc CloneStage {
    cloneID_2 = temp_CloneStage;
    cloneType_2 = "stage//background";
    clone "_myself_";
    temp_CloneStage = "0";
    repeat 10 {
        temp_CloneStage++;
        cloneID_2 = temp_CloneStage;
        cloneType_2 = "stage//Card";
        clone "_myself_";
        cloneType_2 = "stage//defence";
        clone "_myself_";
        cloneType_2 = "stage//focus";
        clone "_myself_";
...
proc StartGame gameinfo {
    ...
    RoundCount = "0";
    StageSize = "50";
    cloneType_2 = "system//inhand";
    clone "_myself_";
    cloneType_2 = "system//detector";
    clone "_myself_";
    cloneType_2 = "system//camera";
    clone "_myself_";
    cloneType_2 = "system//next";
    clone "_myself_";
    cloneType_2 = "system//run";
    clone "_myself_";
    cloneType_2 = "system//shake";
    clone "_myself_";
    cloneType_2 = "system//player";
    clone "_myself_";
    ...
    repeat 10 {
        temp_Start++;
        if (return_DivideString_2[temp_Start] == "") {
        } else {
            PutStage__Enemy return_DivideString_2[temp_Start], temp_Start;
        }
    }
    DebugTest;
...
proc DivideString_2 str, char {
    delete return_DivideString_2;
    add "" to return_DivideString_2;
    temp_DivideString_2 = "0";
    repeat (length $str) {
        temp_DivideString_2++;
        if (letter_of(temp_DivideString, $str) == $char) {
            add "" to return_DivideString_2;
        } else {
            return_DivideString_2[length return_DivideString_2] = (return_DivideString_2[length return_DivideString_2] & letter_of(temp_DivideString, $str));
        }
    }
}
...
proc CloneInhandCard_Type type {
    ...
    repeat (length InhandCard_name_lv_damage_hp_e_ / 5) {
        ...
        cloneID_2 = temp_CloneInhandCard;
        cloneType_2 = ($type & "//Card");
        clone "_myself_";
...
proc StartEnhance {
    cloneType_2 = "system//back";
    clone "_myself_";
    cloneType_2 = "system//enhance";
    clone "_myself_";
    cloneType_2 = "system//detector";
    clone "_myself_";
    cloneType_2 = "system//camera";
    ...
    cloneType_2 = "enhance//damage";
    clone "_myself_";
    cloneType_2 = "enhance//energy";
    clone "_myself_";
    cloneType_2 = "enhance//hp";
    clone "_myself_";
    CloneInhandCard_Type "enhanceCard";
...
proc CloneEffectSingle {
    ...
    point_in_direction 90;
    clear_graphic_effects;
    cloneType_3 = Effect_name__5__[1];
    cloneID_3 = Effect_name__5__[2];
