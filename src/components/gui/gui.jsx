...
import AIChatErrorBoundary from '../ai-chat/ai-chat-error-boundary.jsx';
            ...
            >
                ...
                <Box className={styles.bodyWrapper}>
                    <Box className={styles.flexWrapper}>
                        ...
                        {/* GoboScript: AI chat sidebar. M9 fix: previously nested
                            inside .stage-and-target-wrapper (a COLUMN), which stacked
                            it below the stage, inflated the document height (palette
                            wheel scrolled the whole page) and left workspace/stage
                            unaware of width changes. As a direct child of flex-wrapper
                            it is now a true third column. */}
                        <Box className={styles.aiSidebarWrapper}>
                            <AIChatErrorBoundary>
                                <AIChat vm={vm} />
                            </AIChatErrorBoundary>
                        </Box>
